...
- **A capture-phase hotkey shield.** The widget lives in a Shadow DOM, so this
  page's own shortcuts could not tell that you were typing inside it — `d`
  flipped the theme mid-comment. See
  [hotkeys and the Shadow DOM](/docs/guides/frameworks#hotkeys-and-the-shadow-dom).
